...
const Drawer = (props) => {
  return (
    <div
      ...
      class={` absolute z-40 h-full p-4 overflow-y-auto bg-[#2A3042] w-80 ${
        !props.sideBarOpened && 'hidden'
      }`}
      tabindex="-1"
      ...
      <div class="py-4 overflow-y-auto">
        <ul class="space-y-2">
          <li>
            <a
              href="#"
              class="flex items-center p-2 text-base font-normal text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700"
            >
              <svg
                aria-hidden="true"
          ...
          <li>
            <button
              type="button"
              class="flex items-center w-full p-2 text-base font-normal text-white hover:text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
